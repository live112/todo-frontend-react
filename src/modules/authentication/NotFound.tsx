          ...
          <CardBody className="text-center p-8 space-y-6">
            <div
              className={`p-4 rounded-full mx-auto w-fit ${
                isDarkMode
                  ? "bg-gradient-to-br from-yellow-900/20 to-yellow-800/30"
                  : "bg-gradient-to-br from-warning-50 to-warning-100"
              }`}
            >
              <Icon
                icon="heroicons:face-frown-20-solid" // heroicons:exclamation-triangle-20-solid
                className="w-16 h-16 text-warning-500"
              />
            </div>

            <h1
              className={`text-3xl font-bold bg-gradient-to-r from-warning-500 to-warning-700 bg-clip-text text-transparent`}
            >
